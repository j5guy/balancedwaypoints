...
// vars remain the bootstrap/fallback path for a first run before any admin
// has visited the settings page (see config/ldapAuth.js). Unlike LDAP,
// SMTP here is deliberately per-user (see models/user.js) rather than
// shared — each person configures their own outgoing mail server.
